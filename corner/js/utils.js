...
function open_popup(popup_id) {
    set_attributes_for_element(popup_id, {'style' : {'display' : 'flex'}});
}

function close_popup(popup_id) {
    set_attributes_for_element(popup_id, {'style' : {'display' : 'none'}});
}
...
function readmore_button(file, title, date) {
    ...
    button.add_event_listener('click', async function() {
        ...
        if (div.children.length == 0) {
            ...
            set_attributes_for_element('spinner-container', {'style' : {'display' : 'flex'}});
            set_attributes_for_element('modal', {'style' : {'display' : 'block'}});
            ...
            set_attributes_for_element('spinner-container', {'style' : {'display' : 'none'}});
            set_attributes_for_element('modal', {'style' : {'display' : 'none'}});
        }
        open_popup(file);
    });
    return button;
